...
export const CompanySettingsPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#f6f7f9] text-slate-900 dark:bg-slate-950 dark:text-slate-50 transition-colors duration-300">
            <header className="relative border-b border-slate-200 bg-[#f8f9fb] px-0 pb-9 pt-2 dark:border-slate-800 dark:bg-slate-900">
                <Button
                    variant="outline"
                    className="absolute left-0 top-0 h-12 rounded-l-none rounded-r-lg border-slate-200 bg-white px-5 text-sm font-black uppercase text-slate-950 shadow-sm dark:border-slate-800 dark:bg-slate-950 dark:text-slate-200"
                    onClick={() => navigate("/")}
                >
                ...
                <div className="mx-auto max-w-5xl text-center">
                    ...
                    <p className="mt-12 text-2xl text-slate-600 dark:text-slate-400">
                        Manage your company information, logos, and report configurations
                    </p>
                </div>
            </header>

            <section className="border-b border-slate-200 bg-white px-7 py-8 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                <div className="mb-8 flex items-start gap-3">
                    <Building2 className="mt-1 h-6 w-6 text-[#f7b500]" />
                    <div>
                        <h2 className="text-2xl font-black uppercase leading-tight tracking-tight text-slate-950 dark:text-slate-100">
                ...
                <div className="grid max-w-[1250px] grid-cols-2 gap-x-28 gap-y-8">
                    ...
                    <div>
                        <div className="mb-2 text-lg text-slate-600 dark:text-slate-400">Logos</div>
                        <div className="flex items-center gap-4">
                            {company.logos?.leftLogo ? (
                                <img src={company.logos.leftLogo} alt="Company Logo" className="h-16 w-16 object-contain" />
                            ) : (
                                <div className="flex h-16 w-16 items-center justify-center rounded-md border border-dashed border-slate-300 text-[10px] text-slate-400 bg-slate-50 dark:border-slate-700 dark:bg-slate-800/50">
                                    No Custom Logo
                                </div>
                            )}
            ...
            <Dialog open={isEditorOpen} onOpenChange={setIsEditorOpen}>
                <DialogContent className="max-h-[92vh] overflow-y-auto rounded-xl border border-slate-200 bg-white p-0 text-slate-950 shadow-2xl sm:max-w-[1120px] dark:border-slate-800 dark:bg-slate-950 dark:text-slate-50 [&>button]:right-7 [&>button]:top-7 [&>button]:rounded-md [&>button]:bg-white [&>button]:p-1.5 [&>button]:text-slate-500 [&>button]:shadow-sm [&>button]:ring-1 [&>button]:ring-slate-200 dark:[&>button]:bg-slate-800 dark:[&>button]:text-slate-300 dark:[&>button]:ring-slate-700">
                    <DialogHeader className="px-8 pt-8 text-left">
                        ...
                        <DialogDescription className="mt-5 text-xl text-slate-600 dark:text-slate-400">
                    ...
                    <Tabs defaultValue="basic" className="px-8 pt-6">
                        <TabsList className="grid h-12 w-full grid-cols-5 rounded-xl bg-slate-100 p-1 dark:bg-slate-900">
                            <TabsTrigger value="basic" className="rounded-lg text-lg data-[state=active]:bg-white data-[state=active]:shadow-sm dark:data-[state=active]:bg-slate-800">
                                Basic Info
                            </TabsTrigger>
                            <TabsTrigger value="municipalities" className="rounded-lg text-lg data-[state=active]:bg-white data-[state=active]:shadow-sm dark:data-[state=active]:bg-slate-800">
                                Municipalities
                            </TabsTrigger>
                            <TabsTrigger value="logos" className="rounded-lg text-lg data-[state=active]:bg-white data-[state=active]:shadow-sm dark:data-[state=active]:bg-slate-800">
                                Logos
                            </TabsTrigger>
                            <TabsTrigger value="reports" className="rounded-lg text-lg data-[state=active]:bg-white data-[state=active]:shadow-sm dark:data-[state=active]:bg-slate-800">
                                Report Details
                            </TabsTrigger>
                            <TabsTrigger value="winners" className="rounded-lg text-lg data-[state=active]:bg-white data-[state=active]:shadow-sm dark:data-[state=active]:bg-slate-800">
                                Winner Names
                            </TabsTrigger>
                        </TabsList>
                        ...
                        <TabsContent value="basic" className="mt-9 space-y-7">
                            <Field label="Company Name">
                                <Input
                                    ...
                                    className="h-12 border-slate-200 bg-white text-lg text-slate-950 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100"
                                />
                            </Field>
                            ...
                            <div className="border-t border-slate-200 pt-7">
                                <Field label="DSR/SOD Report Frequency" helper="DSR/SOD reports are generated daily for each batch">
                                    ...
                                    >
                                        <SelectTrigger className="h-12 border-slate-200 bg-white text-lg text-slate-950 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100">
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
                        ...
                        <TabsContent value="municipalities" className="mt-9 space-y-7">
                            <Field label="Add Municipality/City">
                                <div className="flex items-center gap-3">
                                    <Input
                                        ...
                                        className="h-12 flex-1 border-slate-200 bg-white text-lg text-slate-950 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100"
                                        onKeyDown={(e) => {
                            ...
                            <Field label={`Municipalities (${company.municipalities.length})`}>
                                <div className="min-h-[150px] rounded-lg border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900">
                                    {company.municipalities.length === 0 ? (
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {company.municipalities.map((mun, idx) => (
                                                <div key={idx} className="flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 py-2 pl-4 pr-2 text-sm font-medium text-slate-950 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200">
                                                    {mun}
                                                    <button
                        ...
                        <TabsContent value="logos" className="mt-9 space-y-7">
                            <Field label="Left Logo (Company Logo)" helper="PNG, JPG up to 5MB (auto-converted to PNG)">
                                <Input
                                    ...
                                    className="h-12 border-slate-200 bg-white text-base file:mr-4 file:h-full file:border-0 file:bg-transparent file:text-sm file:font-medium text-slate-950 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100"
                                />
                                {company.logos?.leftLogo && (
                        ...
                        <TabsContent value="reports" className="mt-9 space-y-7">
                            <div className="rounded-lg border border-slate-200 bg-slate-50 p-6 dark:border-slate-800 dark:bg-slate-900/50">
                                <h3 className="mb-6 text-xl font-black uppercase text-slate-950 dark:text-slate-100">PREPARED BY (BOOKKEEPER)</h3>
                                <div className="grid grid-cols-2 gap-5">
                                    <Field label="Name">
                                        <Input
                                ...
                                <div className="mt-5">
                                    <Field label="Signature" helper="PNG, JPG up to 5MB">
                                        ...
                                        {company.reportDetails.bookkeeper.signature && (
                                            <div className="mt-4 flex items-center rounded-lg border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900">
                        ...
                        <TabsContent value="winners" className="mt-9 space-y-4">
                            ...
                            <Field label="Enter full names (one per line)">
                                <textarea
                                    ...
                                    className="min-h-[400px] w-full rounded-lg border border-slate-200 bg-white p-4 font-mono text-sm leading-relaxed text-slate-950 focus:border-[#f7b500] focus:outline-none focus:ring-1 focus:ring-[#f7b500] dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100"
                                />
                            </Field>
                    ...
                    <DialogFooter className="mt-8 border-t border-slate-100 px-8 py-6 dark:border-slate-800">
                        <Button variant="outline" className="h-12 px-6 text-lg dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800" onClick={() => setIsEditorOpen(false)}>
                            Cancel
                        </Button>
                        <Button
...
const InfoBlock = ({ label, value, valueClassName = "" }: { label: string; value: string; valueClassName?: string }) => (
    <div>
        <div className="mb-1 text-lg text-slate-600 dark:text-slate-400">{label}</div>
        <div className={`text-2xl font-medium text-slate-950 dark:text-slate-100 ${valueClassName}`}>{value}</div>
    </div>
);

const Field = ({ label, helper, children }: { label: string; helper?: string; children: React.ReactNode }) => (
    <div className="space-y-3">
        <Label className="text-xl font-medium text-slate-950 dark:text-slate-100">{label}</Label>
        {children}
        {helper && <p className="text-base text-slate-600 dark:text-slate-400">{helper}</p>}
    </div>
);
